...
export function AgentsPage() {
  ...
  return <Page title="Agents" description="Define how your agents work. Assign them computers when you start a task." actions={<Button onClick={() => setEditing(null)}>New agent</Button>}>
